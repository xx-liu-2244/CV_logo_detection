...
Logo predictions are performed through [predict_detecto_15logos.py](https://github.com/xx-liu-2244/CV_logo_detection/blob/main/predict_detecto_15logos.py) by calculating the respective Intersection over Union (IoU). IoU is an evaluation metric used to measure the accuracy of an object detector on a particular dataset, especially with convolutional neural networks. In order to apply IoU we need:<br />
