...
__C.TRAIN.ANNOT_PATH            = "./data/dataset/voc_train_xx.txt"
__C.TRAIN.BATCH_SIZE            = 40 #6
__C.TRAIN.INPUT_SIZE            = [640]
__C.TRAIN.DATA_AUG              = False
__C.TRAIN.LEARN_RATE_INIT       = 1e-1 #4
__C.TRAIN.LEARN_RATE_END        = 1e-3 #6
...
__C.TEST.ANNOT_PATH             = "./data/dataset/voc_test_xx.txt"
__C.TEST.BATCH_SIZE             = 2 #2
__C.TEST.INPUT_SIZE             = 640
__C.TEST.DATA_AUG               = False
__C.TEST.WRITE_IMAGE            = True
__C.TEST.WRITE_IMAGE_PATH       = "./data/detection/"
__C.TEST.WRITE_IMAGE_SHOW_LABEL = True
__C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=11.1293.ckpt-1"
